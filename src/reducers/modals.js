...
const MODAL_FIRMWARE_UPDATE = 'firmwareUpdateModal';
...
const closeFirmwareUpdateModal = function () {
    return closeModal(MODAL_FIRMWARE_UPDATE);
};
export {
    reducer as default,
